                ...
                <div className="lg:col-span-4 flex flex-col gap-6">
                    ...
                    <div className="bg-white rounded-[32px] shadow-sm border border-gray-100 flex flex-col h-[500px] relative overflow-hidden">
                        ...
                        <button
                            ...
                            className="p-4 text-xs font-bold text-center text-indigo-600 bg-white border-t border-gray-50 hover:bg-indigo-50 transition-colors uppercase tracking-widest"
                        >
                            Ver Todos
                        </button>
                    </div>
                    ...
                    <div className="space-y-4">
                        <InsightWidget
                            ...
                            items={birthdayItems}
                            color="pink"
                            onClick={() => navigate('/admin/reports?tab=aniversariantes')}
                        />
                        <InsightWidget
...
const InsightWidget = ({ title, icon, count, items, color, onClick }: any) => {
    const bgColors: any = {
    ...
    return (
        <div onClick={onClick} className={`p-4 rounded-3xl border transition-all cursor-pointer group ${bgColors[color]} relative`}>
